			...
			<div className='container mx-auto px-4 py-12'>
				<div className='max-w-4xl mx-auto'>
					<div className='bg-white dark:bg-gray-900 border-t-4 border-t-green-500 dark:border-t-green-600 border-b border-l border-r border-gray-200 dark:border-gray-800 p-8 rounded-md mb-6'>
						...
						<div className='prose prose-green dark:prose-invert max-w-none'>
							<p className='text-gray-600 dark:text-gray-300 mb-8'>
								Welcome to GreenVue. This Privacy Policy explains how we
								collect, use, disclose, and safeguard your information when you
								use our platform. Please read this privacy policy carefully. If
							...
							<div className='p-4 border-l-4 border-amber-500 bg-amber-50 dark:bg-amber-950/30 dark:border-amber-600 mb-8'>
								<p className='text-amber-800 dark:text-amber-300 flex items-start'>
									...
									<span>
										Last updated: May 17, 2025. GreenVue is a non-commercial
										service operated by an individual based in the European
										Union.
									</span>
								</p>
							</div>
							<section className='mb-10'>
								...
								<div className='pl-8 border-l border-gray-200 dark:border-gray-700'>
									...
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										...
										provide when using our Platform, including:
									</p>
									<ul className='list-disc space-y-2 text-gray-600 dark:text-gray-300 ml-4 mb-4'>
										<li>Account information (name, email address, password)</li>
										<li>
											Profile information (profile picture, location, contact
											details)
										</li>
										<li>
										...
										<li>
											Listing information (descriptions, prices, images of items
											you list)
										</li>
										<li>
											When using Google Sign-In, we receive basic profile
									...
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										...
										about how visitors interact with our platform:
									</p>
									<ul className='list-disc space-y-2 text-gray-600 dark:text-gray-300 ml-4 mb-4'>
										<li>
											Basic anonymous metrics (page views, site performance)
										</li>
									...
									<h3 className='font-medium text-gray-800 dark:text-gray-200 mt-4 mb-2'>
										1.3 Minimal Data Collection Statement
									</h3>
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										GreenVue is committed to privacy and only uses Vercel
										Analytics for anonymous usage statistics. We do not collect
										any personal usage data beyond what&apos;s necessary for
										your account functionality. We do not sell data to third
							...
							<section className='mb-10'>
								...
								<div className='pl-8 border-l border-gray-200 dark:border-gray-700'>
									...
									<ul className='list-disc space-y-2 text-gray-600 dark:text-gray-300 ml-4 mb-4'>
										...
										<li>
											To send administrative information (service updates,
											security alerts)
										</li>
									...
									<div className='bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 p-4 rounded-md'>
										<p className='text-gray-600 dark:text-gray-300'>
											<strong>Note:</strong> As a non-commercial service, we do
											not use your data for advertising, marketing, or
							...
							<section className='mb-10'>
								...
								<div className='pl-8 border-l border-gray-200 dark:border-gray-700'>
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										...
										and track information about your interactions with our
										Platform.
									</p>
									...
									<ul className='list-disc space-y-2 text-gray-600 dark:text-gray-300 ml-4 mb-4'>
										...
										<li>
											<strong>Authentication cookies:</strong> Manage user
									...
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										...
										the Platform may become inaccessible or not function
										properly.
									</p>
								</div>
							</section>
							<section className='mb-10'>
								...
								<div className='pl-8 border-l border-gray-200 dark:border-gray-700'>
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										As a non-commercial service operated by a single individual,
										we limit the sharing of your personal information. We may
									...
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										When you create listings or communicate with other users,
										certain information (such as your username, profile picture,
										listing details, and messages) is visible to those users.
										Please be mindful of the information you share in listings
										and messages.
									</p>
									...
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										...
										providers who help us operate and improve our Platform, such
										as hosting providers, authentication services, and analytics
										tools. These providers are contractually obligated to use
										your information only for the purposes of providing services
										to us.
									</p>
									...
									<div className='p-4 border-l-4 border-amber-500 bg-amber-50 dark:bg-amber-950/30 dark:border-amber-600 mb-4'>
										<p className='text-amber-800 dark:text-amber-300 flex items-start'>
											<FaExclamationTriangle className='mr-2 h-5 w-5 flex-shrink-0 mt-0.5' />
											<span>
												<strong>Important:</strong> We do not sell, rent, or
							...
							<section className='mb-10'>
								...
								<div className='pl-8 border-l border-gray-200 dark:border-gray-700'>
									...
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										The security of your account also depends on maintaining the
										confidentiality of your password. Please do not share your
										password with anyone, and notify us immediately if you
									...
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										...
										When your data is no longer needed, we will securely delete
										or anonymize it.
									</p>
								</div>
							</section>
							<section className='mb-10'>
								...
								<div className='pl-8 border-l border-gray-200 dark:border-gray-700'>
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										As a service operated within the European Union, we comply
									...
									<ul className='list-disc space-y-2 text-gray-600 dark:text-gray-300 ml-4 mb-4'>
										<li>
											<strong>Right to access:</strong> You can request copies
											of your personal data.
										</li>
										<li>
											<strong>Right to rectification:</strong> You can request
											that we correct inaccurate or complete incomplete
											information.
										</li>
										<li>
										...
										<li>
											...
											request that we restrict the processing of your data in
									...
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										...
										fee for making a request, but we may charge a reasonable fee
										if your request is clearly unfounded, repetitive, or
										excessive.
									</p>
									...
									<p className='text-gray-600 dark:text-gray-300 mb-4'>
										We provide a data export feature that allows you to download
										a copy of your personal data in a structured, commonly used,
										and machine-readable format. You can access this feature in
							...
							<section className='mb-10'>
								...
								<div className='pl-8 border-l border-gray-200 dark:border-gray-700'>
									...
									<p className='text-gray-600 dark:text-gray-300 mt-4 mb-4'>
										We will respond to your request or inquiry within a
					...
					<div className='bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 rounded-md flex justify-between items-center'>
						<p className='text-gray-600 dark:text-gray-300'>
							By using GreenVue, you agree to the collection and use of
