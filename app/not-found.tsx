		...
		<div className='min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 px-4 py-12'>
			...
			>
				...
				<p className='text-gray-600 dark:text-gray-300 mb-8'>
					Oops! The sustainable resource you&apos;re looking for seems to have
					been recycled.
				</p>
				...
				<div className='flex flex-col sm:flex-row gap-4 justify-center'>
					<Link
						href='/'
						className='flex items-center justify-center gap-2 px-5 py-3 bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white rounded-lg transition-colors'
					>
					...
					<Link
						href='/browse'
						className='flex items-center justify-center gap-2 px-5 py-3 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-lg transition-colors'
					>
