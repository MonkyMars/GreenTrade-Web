		...
		<div className="pt-16">
			<div className="bg-amber-100 text-amber-800 px-4 py-3 flex justify-between items-center w-full z-50 relative">
				...
				<div className="flex items-center space-x-3">
					<button onClick={handleResendEmail} className="bg-amber-200 text-amber-800 hover:bg-amber-200/50 focus:outline-none rounded-md px-4 py-2 text-sm cursor-pointer">
						Resend Email
					</button>
					<button
						onClick={handleClose}
