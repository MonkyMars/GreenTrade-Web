...
const DeleteAccount: React.FC<DeleteAccountProps> = ({ handleDeleteAccount }) => {
				...
				{!showDeleteConfirm ? (
					...
					<div className="border-t border-gray-200 dark:border-gray-700 pt-6">
						...
						<p className="text-gray-600 dark:text-gray-400 mb-4">
							Please type <strong className="text-red-600 dark:text-red-400 font-medium">delete my account</strong> below to confirm:
						</p>
						...
						<div className="mb-6">
							<input
								...
								className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 dark:bg-gray-800 dark:text-white transition-all duration-200 hover:border-red-400 dark:hover:border-red-600"
							/>
						</div>
