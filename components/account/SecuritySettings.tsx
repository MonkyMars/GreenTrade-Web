...
const SecuritySettings = () => {
	...
	const sectionDividerClasses = "border-t border-gray-200 dark:border-gray-700 pt-6";

	// Form input classes
	const inputGroupClasses = "group";
	const inputLabelClasses = "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-200";
	const inputFieldClasses = "w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 dark:bg-gray-800 dark:text-white transition-all duration-200 hover:border-green-400 dark:hover:border-green-600";
